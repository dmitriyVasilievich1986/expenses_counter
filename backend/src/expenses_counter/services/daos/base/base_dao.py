...
class BaseDAO[DatabaseModel: Base](ABC):
    ...
    def concat_filters(self, filters: FilterType) -> list[ColumnElement[bool]]:
    ...
    async def _get_total_raw(self, session: AsyncSession, filters: FilterType = None) -> int:
    ...
    async def get_total(self, filters: FilterType = None) -> int:
    ...
    async def _get_all_raw(
        ...
        Args:
            ...
            filters (FilterType): Extra WHERE clauses.
