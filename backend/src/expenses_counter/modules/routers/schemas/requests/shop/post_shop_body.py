"""Post shop body schema module."""

__all__ = ("PostShopBody",)
...
class PostShopBody(BaseRequestModel):
    """Request body for creating a shop."""

    name: str = Field(..., min_length=1, max_length=150, description="The name of the shop")
