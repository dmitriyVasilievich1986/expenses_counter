...
class TestGetAddressById:
    ...
    def test_get_address_by_id_success(self, test_client, mock_address_dao):
        ...
        mock_address_dao.get_by_pk.return_value = mock_address
        ...
        # Assert
        assert response.status_code == 200
        mock_address_dao.get_by_pk.assert_called_once_with(address_id)

    def test_get_address_by_id_not_found(self, test_client, mock_address_dao):
        """Test retrieval of non-existent address."""
        # Arrange
        mock_address_dao.get_by_pk.side_effect = NoResultFound("Address not found")
    ...
    def test_get_address_by_id_db_error(self, test_client, mock_address_dao):
        ...
        # Arrange
        mock_address_dao.get_by_pk.side_effect = DatabaseError("SELECT *", None, Exception("Database error"))
